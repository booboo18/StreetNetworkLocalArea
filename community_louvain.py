# code borrows/adapted from https://github.com/taynaud/python-louvain #
...
def community_modularity(G):
    """Return the partition of the edges at the given level"""
...
def visualise_community(newpath,DG,communities):
    """Visualise the partition of the edges at the given level"""
